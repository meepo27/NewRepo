...
const CURRENCIES = ['INR', 'USD', 'GBP', 'EUR', 'AUD', 'SGD', 'AED'] as const;
...
export function TripBuilderStage() {
  ...
  const destination = store.chosenDestination;
  ...
  const [currency, setCurrency] = useState<'INR' | 'USD' | 'GBP' | 'EUR' | 'AUD' | 'SGD' | 'AED'>('USD');
    ...
    <div className="min-h-dvh px-4 py-6">
      <div className="max-w-xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-8">
          <button
            onClick={() => store.setStage('shortlist')}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                <label className="text-white/50 text-xs">Minimum</label>
                <input
                  type="number"
                  value={budgetMin}
              ...
              <div className="space-y-1.5">
                <label className="text-white/50 text-xs">Maximum</label>
                <input
                  type="number"
                  value={budgetMax}
          ...
          >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
              {TRIP_STYLES.map(({ id, label, icon, desc }) => (
                ...
                >
                  <span className={cn('block mb-1', tripStyle === id ? 'text-amber-400' : 'text-white/60')}>
                    {icon}
                  </span>
