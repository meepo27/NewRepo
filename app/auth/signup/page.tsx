...
export default function SignupPage() {
    ...
    return (
      <div className="min-h-dvh flex items-center justify-center px-4" style={{ background: '#0A0F1E' }}>
        ...
        >
          ...
          <h1 className="text-white font-semibold text-xl mb-2">Check your email</h1>
          <p className="text-white/50 text-sm">
            We sent a confirmation link to <span className="text-white">{email}</span>.
            Click it to activate your account.
          </p>
          <Link href="/auth/login" className="block mt-6 text-amber-400 text-sm hover:text-amber-300 transition-colors">
            Back to sign in
          </Link>
        </motion.div>
      </div>
  ...
  return (
    <div className="min-h-dvh flex items-center justify-center px-4" style={{ background: '#0A0F1E' }}>
      <div className="fixed inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse at 70% 30%, rgba(139,175,139,0.06) 0%, transparent 60%)' }} />
      <motion.div
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-white font-semibold text-2xl mt-6">Create your account</h1>
          <p className="text-white/40 text-sm mt-1">Start planning your dream trips</p>
        </div>
